...
SECRET_KEY = 'django-insecure-34o#%cut&-*+*9qju^4#cy1@m%$e18n&-@_e=a4pc3v)+k01q3'
...
INSTALLED_APPS = [
    ...
    'trydjangoProject11.apps.Trydjangoproject11Config',
]
...
LOGIN_REDIRECT_URL = 'customer_profileinfopage'
LOGIN_URL = 'login'
